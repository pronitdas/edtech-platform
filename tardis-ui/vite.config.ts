...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'TARDIS EdTech Platform',
        short_name: 'TARDIS',
        description: 'Teaching with Adaptive Real-time Dynamic Interactive Systems - AI-powered educational platform',
        theme_color: '#3b82f6',
        ...
        shortcuts: [
          ...
          },
          {
            ...
            url: '/practice',
            icons: [{ src: '/icons/practice.png', sizes: '192x192' }]
          }
        ]
      },
      workbox: {
