...
export const fileStructureIssues = {
  uiComponents: {
    card: {
      ...
      recommendation: 'Consolidate into a single Card.tsx following PascalCase convention'
    },
    dialog: {
      duplicates: [
      ...
      recommendation: 'Consolidate into a single Dialog.tsx following PascalCase convention'
    }
  },
  videoPlayer: {
    duplicates: [
    ...
    recommendation: 'Consolidate video player implementations into src/components/video directory. Consider keeping ModernVideoPlayer.tsx as the main implementation if it contains the latest features.'
  }
};
