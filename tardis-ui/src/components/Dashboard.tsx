    ...
    const mockPracticeTools: PracticeCard[] = [
      {
        ...
        description: 'Test your understanding with multiple-choice questions about key concepts',
        icon: <BookOpen />,
        difficulty: 'beginner',
      ...
      },
      {
        ...
        description: 'Apply your knowledge to solve real-world problems and scenarios',
        icon: <Brain />,
      ...
      },
      {
        ...
        description: 'Practice implementing algorithms and solving coding problems',
        icon: <Dumbbell />,
        difficulty: 'advanced',
            ...
            >
              <CardContent className="pt-6">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <span className={`text-xs px-2 py-0.5 rounded-full ${getDifficultyColor(tool.difficulty)}`}>
