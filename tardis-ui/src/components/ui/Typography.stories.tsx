...
const meta: Meta<typeof Typography> = {
  ...
  argTypes: {
    variant: {
      control: 'select',
      options: ['h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'p', 'lead', 'large', 'small', 'muted', 'caption'],
...
export const Paragraph: Story = {
  args: {
    variant: 'p',
    children: 'This is a paragraph of text. It demonstrates the standard paragraph styling with proper line height and spacing.'
  }
};
