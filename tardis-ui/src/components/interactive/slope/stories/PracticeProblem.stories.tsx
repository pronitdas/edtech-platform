...
const sampleProblems: Problem[] = [
  {
    ...
    difficulty: 'easy',
    hints: ['Try starting at the origin (0,0)', 'Remember: slope is rise over run'],
    solution: { slope: 2, yIntercept: 0 },
    targetPoints: [{ x: 0, y: 0 }, { x: 1, y: 2 }],
  },
  {
    id: 'prob-2',
    question: 'Draw a line with slope = -1 passing through point (2,3)',
    difficulty: 'medium',
    hints: ['Start at the given point (2,3)', 'For slope -1, when x increases by 1, y decreases by 1'],
    solution: { slope: -1, yIntercept: 5 },
    targetPoints: [{ x: 2, y: 3 }, { x: 3, y: 2 }],
  },
];
