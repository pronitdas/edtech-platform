...
const sampleConcepts: Concept[] = [
  {
    ...
    content:
      'A line that rises from left to right has a positive slope. As x increases, y increases. This means the rate of change is positive.',
  ...
  },
  {
    ...
    content:
      'A line that falls from left to right has a negative slope. As x increases, y decreases.',
    formula: '$$m = \\frac{y_2 - y_1}{x_2 - x_1} < 0$$',
    demoPoints: [
      { x: -2, y: 3 },
      { x: 2, y: -1 },
