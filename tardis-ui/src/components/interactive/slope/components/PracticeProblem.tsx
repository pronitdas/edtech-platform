  ...
  return (
    <div className="bg-gray-800 p-4 rounded-md flex flex-col h-full">
      ...
      {currentProblem ? (
        <div className="flex-grow">
          ...
          {showSolution && currentProblem.solution && (
            <div className="p-3 bg-gray-900 rounded-md border-l-4 border-blue-500 mb-4">
              ...
              <p className="text-gray-300 whitespace-pre-line">{currentProblem.solution}</p>
            </div>
          )}
        ...
        <div className="flex-grow flex items-center justify-center bg-gray-900 rounded-md p-8">
      ...
      {/* Stats display */}
      <div className="mt-4 p-3 bg-gray-900 rounded-md grid grid-cols-4 gap-2 text-center">
        <div>
