        ...
        <div style={{ height: 520 }} className="max-w-3xl mx-auto bg-white overflow-hidden border-0 shadow-lg rounded-lg">
            ...
            <div className="space-y-2 mt-2">
                <div className="flex items-center gap-2 ml-2">
                    <Textarea
                        className="flex-grow p-3 text-gray-800 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 resize-none"
                    ...
                    <Button
                        ...
                        size="icon"
                        className={`h-12 w-12 mr-2 ${isListening ? "bg-red-500 hover:bg-red-600" : ""}`}
                        style={{ color: 'black' }}
                        disabled={isLoading}
