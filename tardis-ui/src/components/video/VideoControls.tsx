...
const VideoControls: React.FC<VideoControlsProps> = ({
  ...
  return (
    <div className={`video-controls flex items-center p-2 bg-gray-800 bg-opacity-80 rounded-b ${className}`}>
      {/* Play/Pause Button */}
      <button
        onClick={onPlayPause}
      ...
      {/* Time Display */}
      <div className="text-white text-sm mx-2" aria-live="polite">
