...
const VideoTimeline: React.FC<VideoTimelineProps> = ({
  ...
  return (
    <div 
      ref={containerRef}
      className={`video-timeline relative w-full h-10 flex items-center ${className}`}
    >
      <input
        ref={timelineRef}
        type="range"
      ...
      {/* Render markers */}
      <div className="markers-container absolute top-0 left-0 right-0 h-full pointer-events-none">
        {renderMarkers()}
      </div>
