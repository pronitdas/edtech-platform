  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <nav className="fixed w-full bg-white/80 backdrop-blur-md z-50 shadow-sm">
        <div className="container mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="text-3xl font-bold text-blue-600">Ai Study Tools</div>
      ...
      <motion.section 
        ...
        className="container mx-auto px-6 pt-32 pb-20 flex flex-col md:flex-row items-center"
      >
        ...
        >
          ...
          <div className="w-full h-96 bg-gradient-to-br from-blue-100 to-blue-50 rounded-2xl shadow-2xl flex items-center justify-center relative overflow-hidden">
            <div className="absolute inset-0 bg-blue-600/5"></div>
            <p className="text-gray-500 text-lg">Interactive Learning Platform Preview</p>
          </div>
        </motion.div>
      </motion.section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 italic">
                "The AI-powered learning paths and real-time feedback transformed my learning journey. 
                I went from basic coding knowledge to landing my dream job at Google in just 6 months!"
              </p>
            ...
            >
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h4 className="text-xl font-bold text-gray-800">Michael Rodriguez</h4>
                  <p className="text-blue-600">Data Scientist at Tesla</p>
                </div>
              </div>
              <p className="text-gray-600 italic">
                "The interactive projects and AI assistant helped me master complex concepts quickly. 
                The platform's analytics showed me exactly where to focus my efforts."
              </p>
              <div className="mt-6 flex items-center">
                <div className="flex text-yellow-400">
                  {[...Array(5)].map((_, i) => (
            ...
            >
              ...
              <p className="text-gray-600 italic">
                "The collaborative features and real-world projects gave me practical experience. 
                I could learn at my own pace while getting feedback from industry experts."
              </p>
              <div className="mt-6 flex items-center">
                <div className="flex text-yellow-400">
                  {[...Array(5)].map((_, i) => (
          ...
          <div className="flex flex-col lg:flex-row items-center">
            ...
            >
              <div className="relative">
                <div className="w-full h-96 bg-gradient-to-br from-blue-100 to-blue-50 rounded-2xl shadow-2xl overflow-hidden">
                  <div className="absolute inset-0 bg-blue-600/5"></div>
                  <p className="text-gray-500 text-lg absolute inset-0 flex items-center justify-center">
                    Team of Education Experts
                  </p>
                </div>
                <div className="absolute -bottom-6 -right-6 w-72 h-72 bg-blue-600/10 rounded-full blur-3xl"></div>
              </div>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                We're a team of educators, technologists, and learning experts passionate about 
                transforming education. Our AI-powered platform combines cutting-edge technology 
                with proven learning methodologies to create an engaging and effective learning 
                experience.
              </p>
              <p className="text-gray-600 mb-8 leading-relaxed">
                Founded in 2020, we've helped over 50,000 learners master new skills and advance 
                their careers. Our platform continuously evolves, incorporating the latest 
                advancements in AI and educational technology to provide the best learning 
                experience possible.
              </p>
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-gray-600">
                    To make high-quality education accessible, engaging, and effective for everyone.
                  </p>
                </div>
                <div>
                  <h4 className="text-xl font-bold text-gray-800 mb-2">Our Vision</h4>
                  <p className="text-gray-600">
                    To become the world's leading platform for personalized online learning.
                  </p>
                </div>
              </div>
            </motion.div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-8">
            <div>
              <h3 className="text-2xl font-bold mb-4">Ai Study Tools</h3>
              <p className="text-gray-400 mb-4">
                Transforming the way people learn with AI-powered, interactive, and 
